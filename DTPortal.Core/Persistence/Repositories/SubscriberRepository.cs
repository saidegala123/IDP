...
namespace DTPortal.Core.Persistence.Repositories
{
        ...
        ISubscriberRepository
    {
        ...
        public async Task<SubscriberRaDatum> GetSubscriberRaDatumBySuid(string suid)
        {
            ...
            {
                _logger.LogError("GetSubscriberRaDatumBySuid::Database exception {0}", error);
                return null;
            }
        }
        ...
        public async Task<SubscriberView> GetSubscriberDetailsBySuid(string suid)
        {
            ...
            {
                _logger.LogError("GetSubscriberDetailsBySuid::Database exception {0}", error);
                return null;
            }
        }
        ...
        public async Task<SubscriberView> GetSubscriberDetailsByPassportNumber(string pnumber)
        {
            ...
            {
                _logger.LogError("GetSubscriberDetailsByPassportNumber::Database exception {0}", error);
                return null;
            }
        }
        ...
        public async Task<SubscriberView> GetSubscriberDetailsByEmiratesId(string eid)
        {
            ...
            {
                _logger.LogError("GetSubscriberDetailsByEmiratesId::Database exception {0}", error);
                return null;
            }
        }
    }
